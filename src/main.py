...
sys.path.append('./src')
sys.path.append('/home/blacksnow/drones/YourDirectoryID_p0/Phase2/src') #For custom python files import using absolute path
sys.path.append('/home/manoj/blender-3.4.1-linux-x64/3.4/project_dependencies/blender_env/lib/python3.10/site-packages')
